    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSetNameButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
            	//SHARE_CHANNEL_NAME = UUID.randomUUID().toString().substring(0, 11);
            	mChatApplication.hostSetChannelName(SHARE_CHANNEL_NAME);
            	mChatApplication.hostInitChannel();
				
            	mChatApplication.hostStartChannel();
            	mChatApplication.useSetChannelName(SHARE_CHANNEL_NAME);
