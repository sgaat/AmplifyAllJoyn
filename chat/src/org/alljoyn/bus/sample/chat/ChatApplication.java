...
public class ChatApplication extends Application implements Observable {
	 ...
	 */
	private List<MessageObject> mOutbound = new ArrayList<MessageObject>();
	 ...
	 */
	private void addOutboundItem(MessageObject message) {
	 ...
	 * sent.
	 */
	public synchronized MessageObject getOutboundItem() {
	 ...
	 */
	private void addInboundItem(String nickname, MessageObject message) {
	 ...
	 */
	private List<MessageObject> mHistory = new ArrayList<MessageObject>();
	 ...
	 */
	private void addHistoryItem(String nickname, MessageObject message) {
	 ...
	 * deep copy.
	 */
    public synchronized List<MessageObject> getHistory() {
        List<MessageObject> clone = new ArrayList<MessageObject>(mHistory.size());
        for (MessageObject string : mHistory) {
        	MessageObject m = new MessageObject();
        	m.color = string.color;
        	m.message = string.message;
        	m.messageType = string.messageType;
        	m.pointerPosition = string.pointerPosition;
        	m.xCord = string.xCord;
        	m.xOldCord = string.xOldCord;
        	m.yCord = string.yCord;
        	m.yOldCord = string.yOldCord;
        	m.isSelf = string.isSelf;
            clone.add(m);
        }
        return clone;
    }
